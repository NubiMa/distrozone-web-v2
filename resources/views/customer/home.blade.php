...
<div class="px-6 py-8">
        ...
        <div class="lg:col-span-2">
            <div class="relative bg-gradient-to-br from-gray-800 to-gray-600 border-4 border-black rounded-3xl overflow-hidden shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] h-[500px]">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-8">
                    ...
                    <a href="{{ route('customer.catalog') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-white text-black font-bold border-3 border-black rounded-xl shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all w-fit">
    ...
    <div class="mb-12">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('customer.catalog') }}" class="text-sm font-bold text-pink-600 hover:underline">
                Lihat Semua →
            </a>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <a href="{{ route('customer.catalog', ['category' => strtolower($category)]) }}" class="group">
    ...
    <div>
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('customer.catalog', ['filter' => 'new']) }}" class="text-sm font-bold text-pink-600 hover:underline">
                Lihat Semua →
            </a>
        </div>
