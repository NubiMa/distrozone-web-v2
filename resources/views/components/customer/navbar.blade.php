...
<nav class="bg-white border-4 border-black rounded-full mx-6 my-4 px-8 py-3 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            {{-- Wishlist --}}
            <a href="#" class="relative w-11 h-11 border-3 bg-[#00f0ff] border-black rounded-full flex items-center justify-center hover:bg-gray-50 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all">
            ...
            {{-- Cart with Badge --}}
            <a href="{{ route('customer.cart') }}" class="relative w-11 h-11 bg-[#D90166] border-3 border-black rounded-full flex items-center justify-center hover:bg-pink-700 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all">
            ...
            <div x-data="{ open: false }" class="relative">
                <button @click="open = !open" class="flex items-center gap-2 px-4 py-2 border-3 border-black rounded-full hover:bg-gray-50 transition shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all">
