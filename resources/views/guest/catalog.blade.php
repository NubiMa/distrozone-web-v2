{{-- resources/views/guest/catalog.blade.php --}}
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white border-4 border-black rounded-2xl p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] sticky top-6">
                ...
                <form action="{{ route('guest.catalog') }}" method="GET" class="space-y-6">
            ...
            <div class="flex items-center justify-between mb-6 bg-white border-3 border-black rounded-xl p-4 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-2">
                        <a href="{{ route('guest.catalog', ['filter' => 'new']) }}" class="px-3 py-1 bg-blue-400 text-white text-xs font-bold border-2 border-black rounded-full hover:bg-blue-500 transition shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                            NEW DROP
                        </a>
                        <a href="{{ route('guest.catalog', ['filter' => 'sale']) }}" class="px-3 py-1 bg-pink-600 text-white text-xs font-bold border-2 border-black rounded-full hover:bg-pink-700 transition shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                            SALE
                        </a>
                    </div>
                </div>
                ...
                <div class="relative">
                    <select
                        name="sort"
                        onchange="window.location.href='{{ route('guest.catalog') }}?sort='+this.value"
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-6 mb-8">
                ...
                @empty
                    <div class="col-span-3 text-center py-16">
                        ...
                        <a href="{{ route('guest.catalog') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-pink-600 text-white font-bold border-3 border-black rounded-xl shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all">
                            Reset Filter
                        </a>
                    </div>
                @endforelse
